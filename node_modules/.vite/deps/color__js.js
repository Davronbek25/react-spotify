...
// node_modules/color.js/dist/color.esm.js
...
var getProminent = (data, args) => {
  ...
  return format(Object.entries(colors).sort(([_keyA, valA], [_keyB, valB]) => valA > valB ? -1 : 1).slice(0, args.amount).map(([rgb2]) => rgb2), args);
};
...
//# sourceMappingURL=color__js.js.map
